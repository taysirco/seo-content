...
export function ReadabilitySuggestions({ content }: ReadabilitySuggestionsProps) {
    ...
    const analysis = useMemo(() => {
        ...
        return {
            ...
            score: Math.max(0, 100 - (longSentences.length * 2) - (veryLongSentences.length * 4) - (longParagraphs.length * 5)),
        };
    }, [content]);
        ...
        <div className="rounded-lg border bg-card">
            ...
            >
                <span className="flex items-center gap-2">
                    ...
                    {(analysis.longSentencesCount > 0 || analysis.longParagraphsCount > 0) && (
            ...
            {expanded && (
                <div className="px-4 pb-4 space-y-3 border-t pt-3">
                    <div className="grid grid-cols-2 gap-2 text-xs">
                        ...
                        <div className="p-2 rounded bg-muted/30 border">
                            <span className="text-muted-foreground">Very Long Sentences:</span>
                    ...
                    {(analysis.longSentencesCount > 0 || analysis.longParagraphsCount > 0) ? (
                        ...
                        <p className="text-xs text-green-600 flex items-center gap-1">
                            ✓ Good readability! Sentences and paragraphs are concise.
                        </p>
                    )}
                </div>
            )}
